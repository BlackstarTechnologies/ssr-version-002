...
function Link({ text, href }) {
  return (
    <a
      href={href}
      className="px-2 mx-2 h-full flex items-center justify-center hover:bg-[#00000067]"
    >
      {text}
    </a>
  );
...
function Nav(props) {
  const sqr = 32;
  return (
    <div className="sticky top-0 z-10 w-full flex-initial  flex  bg-[#79ecf0] ">
      <div
        id="NavLeft"
        className="flex items-center justify-center text-[#ffffb0] text-[2rem]"
      >
        <Image
